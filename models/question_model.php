...
class Question extends Model
{
   ...
   {
      $db = new Database;
      $testId = $array['testId'] ? $array['testId'] : 1 ;
      $question = $array['question'] ? $array['question'] : '';
      $questionImage = $array['qFileName'] ? $array['qFileName'] : '';
      $questionData = $array['questionData'] ? $array['questionData'] : '';
      $answers = $array['answers'] ? $array['answers'] : '';
      $questionType = $array['questionType'] ? $array['questionType'] : '';
      $isRandom = $array['isRandom'] ? $array['isRandom'] : 0;
      $order = $array['order'] ? $array['order'] : 1;
      // print_r($array);
      try {
